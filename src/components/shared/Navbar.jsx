      ...
      <li>
        <div className="dropdown dropdown-hover px-0">
          ...
          >
            ...
            <li>
              <Link href="/news/Web Dev" className={isActive("/news/Web Dev")}>
                Web Dev
              </Link>
            </li>
            <li>
              <Link href="/news/Career" className={isActive("/news/Career")}>
                Career
              </Link>
            </li>
          </ul>
        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              ...
              <li><Link href="/saradesh" className="text-red-500 font-bold">Sara Desh</Link></li>
            </ul>
          </div>
