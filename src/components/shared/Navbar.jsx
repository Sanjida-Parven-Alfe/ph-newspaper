              ...
              <li>
                <details>
                  ...
                  <ul className="p-2">
                    ...
                    <li>
                      <Link href="/news/Startups" onClick={closeDropdown}>
                        Startups
                      </Link>
                    </li>
                    <li>
                      <Link href="/news/AI & Future" onClick={closeDropdown}>
                        AI & Future
                      </Link>
                    </li>
                    <li>
                      <Link href="/news/Web Dev" onClick={closeDropdown}>
                        Web Dev
                      </Link>
                    </li>
                    <li>
                      <Link href="/news/Career" onClick={closeDropdown}>
                        Career
                      </Link>
                    </li>
                  </ul>
